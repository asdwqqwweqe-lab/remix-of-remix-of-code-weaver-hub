    ...
    sections: [
      {
        ...
        topics: [
          { title: "تثبيت Python", subTopics: ["تثبيت على Windows", "تثبيت على Mac/Linux", "إعداد VS Code"] },
          {
            ...
            subTopics: ["String", "Integer", "Float", "Boolean", "Type Conversion"],
          },
          "العمليات الحسابية",
      ...
      },
      {
        ...
        topics: [
          ...
          {
            title: "القوائم Lists",
            subTopics: ["الإنشاء والوصول", "List Methods", "List Slicing", "List Comprehension"],
          },
          {
            title: "القواميس Dictionaries",
            subTopics: ["الإنشاء والوصول", "Dict Methods", "Nested Dicts", "Dict Comprehension"],
          },
          "المجموعات Sets",
          "Tuples",
        ],
    ...
    sections: [
      {
        ...
        topics: [
          {
            title: "تثبيت Django",
            subTopics: ["Python و pip", "Virtual Environment", "Django Installation", "VS Code Setup"],
          },
          {
            title: "إنشاء مشروع جديد",
            subTopics: ["django-admin startproject", "manage.py Commands", "Development Server"],
          },
          ...
          {
            title: "URLs و Views",
            subTopics: ["URL Patterns", "Function-Based Views", "HttpRequest/Response", "URL Parameters"],
          },
        ],
      },
      {
        ...
        topics: [
          {
            ...
            subTopics: ["User Model", "Login/Logout", "Password Management", "Decorators"],
          },
          {
            title: "Permissions & Groups",
            subTopics: ["Model Permissions", "Custom Permissions", "User Groups", "has_perm()"],
          },
    ...
    sections: [
        ...
        topics: [
          {
            ...
            subTopics: ["PHP و Composer", "Laravel Installer", "Valet/Homestead", "Laravel Sail"],
          },
          ...
          {
            title: "Routing",
            subTopics: ["Basic Routes", "Route Parameters", "Named Routes", "Route Groups", "Resource Routes"],
          },
          {
            title: "Controllers",
            subTopics: ["Creating Controllers", "Resource Controllers", "Single Action", "Dependency Injection"],
          },
      ...
      },
      {
        ...
        topics: [
          { title: "Migrations", subTopics: ["Creating Migrations", "Schema Builder", "Modifying Columns", "Indexes"] },
          {
            ...
            subTopics: ["Model Creation", "Mass Assignment", "Accessors/Mutators", "Casting"],
          },
          { title: "Query Builder", subTopics: ["Select", "Where", "Join", "Aggregates", "Raw Queries"] },
          {
            title: "Relationships",
            subTopics: ["One to One", "One to Many", "Many to Many", "Polymorphic", "Eager Loading"],
          },
      ...
      },
      {
        ...
        topics: [
          ...
          {
            title: "Security",
            subTopics: ["CSRF Protection", "XSS Prevention", "SQL Injection", "Encryption", "Hashing"],
          },
          {
            title: "Middleware",
            subTopics: ["Creating Middleware", "Global Middleware", "Route Middleware", "Middleware Groups"],
          },
        ],
      },
      {
        ...
        subSections: [
          {
            ...
            topics: [
              {
                title: "Queues",
                subTopics: ["Queue Configuration", "Creating Jobs", "Dispatching Jobs", "Failed Jobs"],
              },
          ...
          },
          {
            ...
            topics: [
              {
                title: "API Resources",
                subTopics: ["Resource Classes", "Resource Collections", "Conditional Attributes"],
              },
          ...
          },
          {
            ...
            topics: [
              ...
              "File Storage",
              {
                ...
                subTopics: ["Mailable", "Notification Channels", "Queued Notifications"],
              },
        ...
        subSections: [
          ...
          },
          {
            ...
            topics: [
              {
                title: "Performance",
                subTopics: ["React.memo", "useMemo", "useCallback", "Code Splitting", "Lazy Loading"],
              },
    ...
    sections: [
      {
        ...
        topics: [
          ...
          {
            title: "Hooks",
            subTopics: ["Actions vs Filters", "add_action", "add_filter", "Priority", "do_action", "apply_filters"],
          },
      ...
      },
      {
        ...
        topics: [
          ...
          { title: "Plugin Headers", subTopics: ["Plugin Name", "Description", "Version", "Author", "License"] },
          {
            ...
            subTopics: ["register_activation_hook", "register_deactivation_hook", "Cleanup"],
          },
      ...
      },
      {
        ...
        topics: [
          ...
          { title: "Slots", subTopics: ["Default Slot", "Named Slots", "Scoped Slots", "Slot Props"] },
          {
            ...
            subTopics: ["Parent-Child", "Provide/Inject", "Event Bus", "State Management"],
          },
          "Dynamic Components",
          "Async Components",
        ],
        ...
        subSections: [
          {
            ...
            topics: [
              ...
              {
                title: "Navigation",
                subTopics: ["Programmatic Navigation", "Route Params", "Query Params", "Hash Mode"],
              },
          ...
          },
          {
            ...
            topics: [
              { title: "Pinia", subTopics: ["Stores", "State", "Getters", "Actions", "Plugins"] },
              {
                ...
                subTopics: ["Composition API Stores", "Persisting State", "Store Subscriptions"],
              },
              "Vuex (Legacy)",
              "State Patterns",
            ],
    ...
    sections: [
      {
        ...
        topics: [
          {
            title: "التثبيت والإعداد",
            subTopics: ["Nest CLI", "@nestjs/cli", "TypeScript Config", "Project Creation"],
          },
          { title: "بنية المشروع", subTopics: ["src/", "main.ts", "app.module", "Folder Structure"] },
          {
            title: "Modules",
            subTopics: ["@Module Decorator", "Feature Modules", "Shared Modules", "Dynamic Modules"],
          },
          ...
          { title: "Providers", subTopics: ["@Injectable", "Services", "Provider Scope", "Custom Providers"] },
          {
            ...
            subTopics: ["Constructor Injection", "Property Injection", "Injection Tokens"],
          },
        ],
      },
      {
    ...
    sections: [
      {
        ...
        topics: [
          ...
          {
            title: "Navigation",
            subTopics: ["Link Component", "useRouter", "usePathname", "useSearchParams", "redirect"],
          },
        ],
      },
      {
        ...
        topics: [
          {
            ...
            subTopics: ["Default Behavior", "async/await", "Data Fetching", "Performance"],
          },
      ...
      },
      {
        ...
        topics: [
          {
            title: "Form Actions",
            subTopics: ["Server Actions", "useFormState", "useFormStatus", "Progressive Enhancement"],
          },
    ...
    sections: [
      {
        ...
        topics: [
          { title: "المتغيرات", subTopics: ["let", "const", "var", "Hoisting", "Scope"] },
          {
            ...
            subTopics: ["String", "Number", "Boolean", "Null", "Undefined", "Symbol", "BigInt"],
          },
          ...
          {
            title: "الدوال",
            subTopics: ["Function Declaration", "Function Expression", "Arrow Functions", "Parameters", "Return"],
          },
        ],
      },
      {
        ...
        topics: [
          {
            title: "Arrays",
            subTopics: ["Creation", "Indexing", "push/pop", "shift/unshift", "slice/splice", "map/filter/reduce"],
          },
          { title: "Objects", subTopics: ["Object Literal", "Properties", "Methods", "this", "Object Methods"] },
          {
            title: "Destructuring",
            subTopics: ["Array Destructuring", "Object Destructuring", "Default Values", "Nested"],
          },
        ...
        subSections: [
          {
            ...
            topics: [
              ...
              {
                title: "Promises",
                subTopics: ["Creating Promises", "then/catch", "Promise.all", "Promise.race", "Chaining"],
              },
            ...
            topics: [
              {
                ...
                subTopics: ["querySelector", "createElement", "appendChild", "setAttribute"],
              },
              {
                title: "Events",
                subTopics: ["addEventListener", "Event Object", "Event Delegation", "Event Bubbling"],
              },
    ...
    sections: [
      {
        ...
        topics: [
          {
            title: "التثبيت والإعداد",
            subTopics: ["Python 3.7+", "pip install fastapi", "pip install uvicorn", "Virtual Environment"],
          },
          { title: "أول API", subTopics: ["FastAPI Instance", "Path Operation", "@app.get", "Running with Uvicorn"] },
          {
            title: "فهم المسارات",
            subTopics: ["Path Parameters", "Query Parameters", "Request Body", "Response Model"],
          },
      ...
      },
      {
        ...
        topics: [
          ...
          {
            title: "Validation",
            subTopics: ["Field Validation", "Custom Validators", "validator Decorator", "Error Messages"],
          },
          ...
          {
            title: "Dependencies",
            subTopics: ["Depends()", "Dependency Injection", "Sub-dependencies", "Classes as Dependencies"],
          },
          "Nested Models",
        ],
      },
        ...
        subSections: [
          {
            ...
            topics: [
              ...
              {
                title: "JWT Tokens",
                subTopics: ["python-jose", "Creating Tokens", "Verifying Tokens", "Refresh Tokens"],
              },
    ...
    sections: [
      {
        ...
        topics: [
          { title: "التثبيت والإعداد", subTopics: ["Dart SDK", "DartPad", "VS Code Setup", "Android Studio"] },
          {
            ...
            subTopics: ["var/final/const", "int/double/String", "bool", "dynamic", "Type Inference"],
          },
          ...
          {
            title: "الدوال",
            subTopics: ["Function Declaration", "Arrow Functions", "Optional Parameters", "Named Parameters"],
          },
        ...
        topics: [
          {
            ...
            subTopics: ["Class Definition", "Constructors", "Named Constructors", "Factory Constructors"],
          },
          { title: "Inheritance", subTopics: ["extends", "super", "Override", "@override"] },
          {
            title: "OOP Concepts",
            subTopics: ["Abstract Classes", "Interfaces (implements)", "Mixins", "Extension Methods"],
          },
      ...
      },
      {
        ...
        topics: [
          {
            title: "التثبيت والإعداد",
            subTopics: ["Flutter SDK", "flutter doctor", "Creating Project", "Emulator Setup"],
          },
      ...
      },
      {
        ...
        topics: [
          ...
          {
            title: "Navigation",
            subTopics: ["Navigator", "Routes", "Named Routes", "Passing Data", "onGenerateRoute"],
          },
        ...
        subSections: [
          ...
          },
          {
            ...
            topics: [
              {
                title: "HTTP & APIs",
                subTopics: ["http Package", "Dio", "REST APIs", "JSON Parsing", "Error Handling"],
              },
    ...
    sections: [
      {
        ...
        topics: [
          { title: "إنشاء مشروع", subTopics: ["npm init", "Installing Express", "Basic Server", "nodemon"] },
          {
            ...
            subTopics: ["app.get/post/put/delete", "Route Parameters", "Query Strings", "Route Paths"],
          },
      ...
      },
      {
        ...
        topics: [
          {
            title: "JWT Auth",
            subTopics: ["jsonwebtoken", "Token Generation", "Token Verification", "Refresh Tokens"],
          },
    ...
    sections: [
      {
        ...
        topics: [
          ...
          {
            title: "Directives",
            subTopics: ["*ngIf", "*ngFor", "*ngSwitch", "ngClass", "ngStyle", "Custom Directives"],
          },
          {
            title: "Data Binding",
            subTopics: ["String Interpolation", "Property Binding", "Event Binding", "Two-way"],
          },
        ],
      },
      {
        ...
        topics: [
          ...
          {
            title: "Routing",
            subTopics: ["Router Module", "Routes", "RouterLink", "RouterOutlet", "Route Parameters"],
          },
      ...
      },
      {
        ...
        topics: [
          ...
          { title: "Reactive Forms", subTopics: ["FormControl", "FormGroup", "FormBuilder", "Validators"] },
          {
            ...
            subTopics: ["Built-in Validators", "Custom Validators", "Async Validators", "Error Messages"],
          },
          { title: "HttpClient", subTopics: ["GET/POST/PUT/DELETE", "Observables", "Response Types", "Headers"] },
          {
            title: "Interceptors",
            subTopics: ["HTTP Interceptors", "Request/Response Modification", "Error Handling"],
          },
          "RxJS Basics",
        ],
      },
        ...
        subSections: [
          {
            ...
            topics: [
              ...
              {
                title: "Operators",
                subTopics: ["map", "filter", "switchMap", "mergeMap", "combineLatest", "forkJoin"],
              },
              "Error Handling",
    ...
    sections: [
      {
        ...
        topics: [
          {
            title: "التثبيت والإعداد",
            subTopics: ["MongoDB Installation", "MongoDB Compass", "Mongo Shell", "Atlas (Cloud)"],
          },
          {
            title: "Documents vs Collections",
            subTopics: ["JSON/BSON", "Document Structure", "Collections", "_id Field"],
          },
          {
            title: "CRUD Basics",
          ...
          {
            title: "Data Types",
            subTopics: ["String", "Number", "Boolean", "Date", "ObjectId", "Array", "Embedded Docs"],
          },
      ...
      },
      {
        ...
        topics: [
          {
            title: "Data Modeling",
            subTopics: ["Embedding vs Referencing", "When to Embed", "When to Reference", "Hybrid Approach"],
          },
          { title: "Relationships", subTopics: ["One-to-One", "One-to-Many", "Many-to-Many", "Design Patterns"] },
          {
            title: "Validation",
            subTopics: ["Schema Validation", "Validation Rules", "JSON Schema", "Validation Levels"],
          },
        ...
        topics: [
          {
            ...
            subTopics: ["$lookup", "$unwind", "$addFields", "$facet", "$bucket", "Complex Pipelines"],
          },
          {
            title: "Advanced Operators",
            subTopics: ["$expr", "$cond", "$switch", "Array Operators", "Date Operators"],
          },
          { title: "Performance", subTopics: ["Query Plans", "explain()", "Slow Queries", "Profiling"] },
          {
            title: "Index Optimization",
            subTopics: ["Index Strategies", "Covered Queries", "Index Intersection", "Index Hints"],
          },
        ...
        subSections: [
          {
            ...
            topics: [
              {
                title: "Replication",
                subTopics: ["Replica Sets", "Primary/Secondary", "Elections", "Read Preference"],
              },
          ...
          },
          {
            ...
            topics: [
              {
                title: "Security",
                subTopics: ["Authentication", "Authorization", "Roles", "Encryption", "Network Security"],
              },
    ...
    sections: [
      {
        ...
        topics: [
          {
            title: "ما هو Git?",
            subTopics: ["Version Control", "Distributed vs Centralized", "Git vs GitHub", "Git Workflow"],
          },
      ...
      },
      {
        ...
        topics: [
          {
            title: "Branching",
            subTopics: ["git branch", "git checkout", "git switch", "Branch Naming", "Branch Strategy"],
          },
          ...
          { title: "Rebase", subTopics: ["git rebase", "Rebase vs Merge", "Interactive Rebase", "Rebase Workflow"] },
          {
            ...
            subTopics: ["Merge Conflicts", "Conflict Markers", "Resolution Tools", "git mergetool"],
          },
      ...
      },
      {
        ...
        topics: [
          ...
          {
            title: "Tags & Releases",
            subTopics: ["git tag", "Lightweight Tags", "Annotated Tags", "Semantic Versioning"],
          },
        ...
        subSections: [
            ...
            topics: [
              {
                ...
                subTopics: ["Conventional Commits", "Commit Structure", "Commit Types", "Scope"],
              },
          ...
          },
          {
            ...
            topics: [
              ...
              {
                title: "Security",
                subTopics: ["Secret Scanning", "Signed Commits", "GPG Keys", "Security Best Practices"],
              },
  ...
  const handleAddRoadmaps = async () => {
    ...
    try {
      for (const roadmapId of selectedRoadmaps) {
        ...
        let language = programmingLanguages.find((l) => l.name.toLowerCase() === roadmap.languageName.toLowerCase());
        ...
        const addTopicsToSection = (sectionId: string, topics: (string | DefaultRoadmapTopic)[]) => {
          ...
          topics.forEach((topic, index) => {
            if (typeof topic === "string") {
              ...
              console.log(
                `  [${index}] Adding topic with subtopics: ${topic.title} (${topic.subTopics?.length || 0} subtopics)`,
              );
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>اختر خرائط الطرق التي تريد إضافتها للبدء بسرعة</DialogDescription>
        </DialogHeader>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {defaultRoadmaps.map((roadmap) => {
            ...
            const totalTopicsWithSubtopics = roadmap.sections.reduce((sum, section) => {
              ...
              const subSectionTopics = (section.subSections || []).reduce(
                (subSum, sub) => subSum + (sub.topics || []).filter((t) => typeof t === "object" && t.subTopics).length,
                0,
              );
            ...
            return (
              <div
                ...
                className={`border rounded-lg p-3 cursor-pointer transition-colors ${
                  selectedRoadmaps.has(roadmap.id) ? "border-primary bg-primary/5" : "hover:border-primary/50"
                }`}
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-2 flex-wrap">
                      ...
                      <span className="text-xs text-muted-foreground">📚 {roadmap.sections.length} أقسام</span>
                      {totalSubsections > 0 && (
                        <span className="text-xs text-muted-foreground">↳ {totalSubsections} فهرس فرعي</span>
                      )}
                      {totalTopicsWithSubtopics > 0 && (
                        <span className="text-xs text-muted-foreground">🔸 {totalTopicsWithSubtopics} موضوع مفصّل</span>
                      )}
                    </div>
                  </div>
                </div>
