...
const MainLayout = ({ children }: MainLayoutProps) => {
  ...
  const navItems = [
    ...
    { path: '/voice-notes', icon: Mic, label: language === 'ar' ? 'ملاحظات صوتية' : 'Voice Notes' },
    { path: '/flashcards', icon: GraduationCap, label: language === 'ar' ? 'البطاقات التعليمية' : 'Flashcards' },
